...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    // Agent Registration / Claim / Revoke Mock & Execution Endpoints
    ...
    // 5. Direct static asset bypass (excluding root or custom routes)
    ...
    // 6. Content Negotiation & Bot-UA routing
