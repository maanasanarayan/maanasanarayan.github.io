const content = {
  ...
  about: {
    skills: {
      Languages:
        'Java, Python, JavaScript (JS), TypeScript (TS), SQL, HTML, CSS',
      'Web Technologies':
        'React, Redux, Node, Express, Spring Boot, RESTful APIs, HTML/CSS/Bootstrap, jQuery, JSON, XML',
      Databases: 'MySQL, MongoDB, SQL, SQLite',
      Tools:
        'AWS Lambda, API Gateway, Elasticsearch, Kibana, Docker, Kubernetes, GitHub Actions, IntelliJ, VS Code, Eclipse, PyCharm, Postman, SoapUI, Android Studio, ServiceNow, Git, Puppeteer, JUnit, Jest',
      'Cloud & DevOps': 'AWS, CI/CD, Serverless Architecture, Containerization',
      'Non-Technical':
        'Detail-oriented, problem solver, fast learner, strong communicator',
    },
    education: [
      {
  ...
  projects: [
    {
      ...
      links: [
        {
          label: 'React repo',
          url: 'https://github.com/maanasanarayan/webdev-cs5610-project',
        },
        {
          label: 'Node repo',
          url: 'https://github.com/maanasanarayan/webdev-cs5610-node-project',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        {
          label: 'GitHub',
          url: 'https://github.com/maanasanarayan/BeatBeat_FinalProject_CS5520',
        },
      ],
    },
  ],
  recommendations: [
    {
      ...
      quote:
        "One of the best interns I've had. Ramp-up was fast, delivery met our needs within 12 weeks.",
    },
    {
      name: 'Cahya Ong',
      role: 'SDE, Amazon',
      logo: '/images/amazon-light.png',
      quote:
        'Quickly picked up new domains, asked the right questions, and delivered results including stretch goals.',
    },
    {
      name: 'Tarence DSouza',
      ...
      logo: '/images/adobe.png',
      quote:
        "Expressive, articulate, and resourceful team member. You'll likely learn a thing or two working with her.",
    },
  ],
  contact: {
